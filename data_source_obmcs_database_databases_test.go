...
func (s *DatasourceDatabaseDBSystemTestSuite) TestAccDatasourceDatabaseDBSystem() {
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				data "oci_database_db_homes" "t" {
					compartment_id = "${var.compartment_id}"
					db_system_id = "ocid1.dbsystem.oc1.phx.abyhqljskxaehm3osd7ekh5sxqdp7y6ob3u54ayo6y57pcvcbk3cf75kd2oa"
				}
